...
<div class="typecho-login-wrap">
    <div class="typecho-login">
        ...
        <form action="<?php $options->loginAction(); ?>" method="post" name="login" role="form" id="login-form">
            <p>
            ...
            <p class="submit">
                <button type="submit" id="login-btn" class="btn btn-l w-100 primary" disabled><?php _e('登录'); ?></button>
